...
Related: [Create a role with the Staplehire CLI](/create-role-cli) · [Research a candidate with Staplehire](/enrich-candidate-cli) · [Interview a candidate with Staplehire](/send-interview-cli)