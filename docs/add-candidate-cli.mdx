...
Related: [Create a role with the Staplehire CLI](/create-role-cli) · [Enrich a candidate with the Staplehire CLI](/enrich-candidate-cli) · [Send an interview with the Staplehire CLI](/send-interview-cli)