...
See [Add a candidate with the Staplehire CLI](/add-candidate-cli), [Enrich a candidate with the Staplehire CLI](/enrich-candidate-cli), and [Send an interview with the Staplehire CLI](/send-interview-cli).
...
See [Poll Staplehire CLI jobs](/poll-agent-jobs).
