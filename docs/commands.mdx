...
See [Add a candidate with the Staplehire CLI](/add-candidate-cli), [Enrich a candidate with the Staplehire CLI](/enrich-candidate-cli), and [Interview a candidate with Staplehire](/send-interview-cli).
